...
def possible_bipartition(dislikes):
    ...
    while to_pet: 
        ...
        for disliked_dog in dislikes[doggie]:
            ...
            ###### 
            # Note that since you don't add the neighbor (disliked_dog) to pet_dogs here, you may end up adding it to the to_pet queue and visiting it multiple times. More specifically this will happen when multiple dogs you visit share a neighbor that you have not yet iterated over.
            # To get a better idea of what's happening here, try printing your queue at the end of each for loop iteration and see what it holds.
            # This doesn't negatively affect your output, but you might consider so that you add each dog to the queue once.
            ######
